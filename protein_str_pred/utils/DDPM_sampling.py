...
from diffusion.DDPM_diffusion import DDPM_DiffusionSampler
import pandas as pd
...
def DDPM_sampling_epoch(args, model, dataset, device='cpu', pdbs=False, elbo=None, model_dir=None, inf_name=None, csv_path=None):
    ...
    for i in tqdm(range(N), desc="proteins"):
        ...
        # Define the sampler
        Sampler = DDPM_DiffusionSampler(args, seqlen).to(device)
